...
|------|-------|-------------------|
| 2026-07-05 | Messagerie d'équipe | Messagerie générale d'équipe en direct (Firestore onSnapshot, trackWrite offline fallback). Ajout des mentions (@prenom / @initiales) avec autocomplétion dynamique lors de la frappe, badges de notification (bleu = messages non lus, rouge = mention directe), mise en valeur visuelle jaune des messages reçus contenant une mention personnelle. |
