...
| 2026-05-23 | Planning Carte ✅ | Carte interactive des tournées (Leaflet, pins colorés, sidebar interactive, mobile horizontal carousel, fallbacks sans GPS). Rendu local 100% OK. |
