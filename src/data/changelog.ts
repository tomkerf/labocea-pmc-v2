...
export const CHANGELOG: ChangelogEntry[] = [
  {
    ...
    date: '21 juin 2026',
    items: [
      { type: 'fix', label: 'Avatars & Couleurs : Aspect 3D brillant type Skittles (brillance radiale, ombres internes, couleurs de techniciens ultra-vibrantes) et ajustement automatique de la taille du texte pour les initiales de plus de 2 lettres.' },
    ],
  },
  {
    version: '125',
