        ...
        >
          ...
          <ChevronDown
            ...
            style={{
              ...
              marginLeft: 'auto',
              transform: rapportsOpen ? 'rotate(0deg)' : 'rotate(-90deg)',
          ...
          >
            ...
            <ChevronDown
              ...
              style={{
                color: 'var(--color-text-tertiary)',
                marginLeft: 'auto',
                transform: retardOpen ? 'rotate(0deg)' : 'rotate(-90deg)',
                transition: 'transform 0.2s ease',
              }}
            />
          </button>
