...
import { ShieldAlert, UserPlus, Check, Loader2, ChevronLeft, ChevronRight, Mail, Lock, User, Hash, BarChart2, Clock, Bug } from 'lucide-react'
import { authSecondary, dbSecondary, db } from '@/lib/firebase'
...
import type { UserRole, BugReport } from '@/types'
