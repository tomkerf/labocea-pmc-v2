...
export default function PlanningHeader({
  ...
  return (
    <div className="flex flex-col shrink-0"
      ...
      <div className="flex flex-col md:flex-row md:flex-wrap md:items-center justify-between px-4 md:px-5 py-2.5 gap-2">
              ...
              {(['jour', 'semaine', 'mois', 'annee'] as ViewMode[]).map(view => {
                ...
                return (
                  <button type="button"
                    ...
                    className="relative px-3 py-1.5 text-xs font-semibold rounded-md z-10 transition-colors duration-200 flex-1 md:flex-none text-center cursor-pointer"
                    style={{
