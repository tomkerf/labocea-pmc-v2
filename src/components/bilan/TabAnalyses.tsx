    ...
    <div className="flex flex-col gap-4">
      <Card>
            ...
            return (
              <div key={row.id} className="grid gap-2 items-center p-2 rounded-lg"
                style={{
                  ...
                  background: conf === true ? 'var(--color-success-light)' : conf === false ? 'var(--color-danger-light)' : COLORS.BG_TERTIARY,
                  border: `1px solid ${conf === true ? COLORS.SUCCESS : conf === false ? COLORS.DANGER : COLORS.BORDER}`,
                }}>
                <input
                  ...
                  style={{ background: COLORS.BG_SECONDARY, border: '1px solid var(--color-border)', color: COLORS.TEXT_PRIMARY, outline: 'none' }}
                />
                <input
                ...
                <input
                  ...
                  style={{ background: COLORS.BG_SECONDARY, border: '1px solid var(--color-border)', color: 'var(--color-text-tertiary)', outline: 'none' }}
                />
                <select
                  ...
                  style={{ background: COLORS.BG_SECONDARY, border: '1px solid var(--color-border)', color: COLORS.TEXT_SECONDARY, outline: 'none' }}>
        ...
        <button type="button" onClick={addRow}
          ...
          style={{ background: 'var(--color-accent-light)', color: COLORS.ACCENT, border: '1px dashed var(--color-accent)' }}>
